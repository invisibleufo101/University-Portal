			...
			<div class="col-3">
				<div class="h-100 d-flex flex-column p-3 border-end bg-body-tertiary">
					<div class="fw-bold fs-4 text-center border-bottom border-2">
						<c:out value="${ sessionScope.currentLecture.courseName }"/>
					</div>
					<ul class="nav nav-pills flex-column mt-2 mb-auto fs-6" >
						<!-- Announcements -->
						<li class="nav-item mb-2">
							<a href="/professor-lecture.do?id=${ sessionScope.currentLecture.id }" class="nav-link link-body-emphasis">
						...
						<!-- Lecture Materials -->
						<li class="nav-item mb-2">
							<a href="/professor-lecture-materials.do?id=${ sessionScope.currentLecture.id }" class="nav-link link-body-emphasis">
								<span class="d-flex align-items-center">								
						...
						<li class="nav-item mb-2">
							<a href="/professor-lecture-grade.do?id=${ sessionScope.currentLecture.id }" class="nav-link link-body-emphasis">
								<span class="d-flex align-items-center">								
									<svg class="pe-none me-2" width="20" height="20" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
